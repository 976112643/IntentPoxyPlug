...
import com.cnsunrun.common.WebActivity;
...
public interface StartIntent {
    ...
    //商品列表, type 0 默认分类页进入 1,限时, 2 爆款 ,3 从预算过来 , 4 搜索 , 5 产品选择,cid分类id,6 从预算过来,添加材料
...
//    void startDetailedEngineeringList(Activity that);//详细工程清单
    ...
    void startMaterialListInfoActivity(Activity that,@Key("id")String id);//材料清单
    @ResultCode(101)
    ...
    void startAddMaterialGoodsActivity(Activity that); //添加材料
